...
order <- data.frame(variable = c("resp_rate",  "heart_rate", "spo2","fio2", 
           "GCS", "po2", "ph","pco2", "pressor", "niv", "stdo2"),
                    var = 1:D)
...
files = c("models/amd_interpolation_obsonly_GP1.csv",
         "models/amd_interpolation_obsonly_GP2.csv",
         "models/amd_interpolation_obsonly_GP3.csv",
         "models/amd_interpolation_obsonly_GP4.csv")
...
svg("amd_plots/amd_interpolation_GP_rho_trace_obsonly.svg",
   width = 5, height = 5)
rho_trace
dev.off()

svg("amd_plots/amd_interpolation_GP_alpha_trace_obsonly.svg",
   width = 10, height = 8)
alpha_trace
dev.off()

svg("amd_plots/amd_interpolation_GP_sigma_trace_obsonly.svg",
   width = 10, height = 5)
sigma_trace
dev.off()

svg("plots/amd_interpolation_GP_offset_trace_obsonly.svg",
   width = 5, height = 5)
offset_trace
dev.off()
...
svg("amd_plots/interpolation_GP_cov.svg", width = 7, height = 7)
Cov_C[[2]]
dev.off()
...
GP_params <- list(rho = meanrho,
                  ...
                  offset = meanoffset,
                  L_C = meanL_C)
saveRDS(GP_params, "data/amd_gp_params.rds")
