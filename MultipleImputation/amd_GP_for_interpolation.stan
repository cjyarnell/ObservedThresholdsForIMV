...
// for Amsterdam Medical Data Sciences cohort
...
// define offsets and multipliers
  ...
  real logalpha9_offset = 0.7;
  real logalpha9_sd = 0.5;
  real logalpha10_offset = 1.2;
  real logalpha10_sd = 0.5;
  real logalpha11_offset = 0.42;
  real logalpha11_sd = 0.5;
  
  // noise
  real logsigma1_offset = -0.35;
  real logsigma1_sd = 0.5;
  real logsigma2_offset = -35;
  real logsigma2_sd = 0.5;
  real logsigma3_offset = -0.34;
  real logsigma3_sd = 0.5;
  real logsigma4_offset = -0.35;
  ...
  // offset
  real offset1_offset = -6;
  real offset1_sd = 0.5;
  real offset2_offset = -2.45;
  real offset2_sd = 0.5;
  real offset3_offset = -3;
  real offset3_sd = 0.5;
...
// PRIORS
  ...
  logalpha9  ~ normal(logalpha9_offset , prior_alpha_binsd);
  logalpha10  ~ normal(logalpha10_offset , prior_alpha_binsd);
